...
const ComingSoonPage = () => {
  ...
  useEffect(() => {
    ...
    }, 50); // Rafraîchissement ultra-rapide pour la fluidité
  ...
  return (
    <div className="min-h-screen bg-[#FDFDFD] flex flex-col items-center justify-center p-6 md:p-12 overflow-hidden font-sans text-[#0F172A] relative">
      ...
      <div className="absolute top-10 left-10 z-50">
        <img src="/logo.png" alt="Analymo" className="h-14 w-auto" />
      </div>

      <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        {/* TEXTE BASÉ SUR TES CAPTURES */}
        <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} className="space-y-10">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-slate-50 border border-slate-100 rounded-full shadow-sm">
            ...
            <span className="text-xs font-bold text-[#004262] uppercase tracking-wider">
        ...
        >
          <motion.div
            ...
            className="relative w-[310px] h-[630px] bg-[#0F172A] rounded-[3.5rem] p-[10px] shadow-[0_50px_100px_rgba(0,66,98,0.15)] transition-shadow duration-500"
          >
            <div className="h-full w-full bg-white rounded-[2.9rem] overflow-hidden flex flex-col relative">
              {/* Écran Analyse (inspiré de ton image) */}
              <div className="p-6 pt-12 space-y-6">
                <div className="flex justify-between items-center">
                  <span className="text-[10px] font-bold text-slate-400 uppercase">Résultat d'analyse</span>
                  <span className="px-2 py-1 bg-green-50 text-green-600 text-[8px] font-bold rounded-full">
                    Terminé
                  </span>
                </div>
                ...
                <div className="relative w-32 h-32 mx-auto flex items-center justify-center">
                  <svg className="w-full h-full rotate-[-90deg]">
                    ...
                    <motion.circle
                      ...
                      animate={{ strokeDashoffset: 364 - 364 * 0.7 }}
                      transition={{ delay: 1, duration: 1.5 }}
                    />
                  </svg>
                  <div className="absolute inset-0 flex flex-col items-center justify-center">
                    <span className="text-3xl font-black text-[#0F172A]">7</span>
